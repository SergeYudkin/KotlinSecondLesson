...
import com.example.kotlinsecondlesson.databinding.FragmentMainBinding
    ...
    private fun renderData(appState:AppState){
        when(appState){
            ...
            is AppState.Success -> {
                ...
                binding.cityCoordinates.text = "Ш ${appState.weatherData.city.lat } : Д ${appState.weatherData.city.lon}"
